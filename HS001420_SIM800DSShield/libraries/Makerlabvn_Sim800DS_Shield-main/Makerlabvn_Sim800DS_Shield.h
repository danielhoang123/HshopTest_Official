...
Date:			02/02/2017
Link download:	https://github.com/makerlabvn/Makerlabvn_Sim800DS_Shield
Version:		1.0.0

*************************************************************************/
#ifndef _MKL_SIM800DS_SHIELD_
#define _MKL_SIM800DS_SHIELD_
...
class Makerlabvn_Sim800DS_Shield{
	protected:
		String getData;
	public:
	
	#ifdef hardwareSerial
		Makerlabvn_Sim800DS_Shield(HardwareSerial *refSer);
	#else
		#if ARDUINO >= 100
		  Makerlabvn_Sim800DS_Shield(SoftwareSerial *refSer);
		#else
		  Makerlabvn_Sim800DS_Shield(NewSoftSerial *refSer);
		#endif
	#endif
...
#endif		// end _MKL_SIM800DS_SHIELD_
